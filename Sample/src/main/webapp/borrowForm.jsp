		...
		<div>
			...
			<div class="bookform">
				...
				<c:if test="${borrowing != null}">
					...
					<input type="hidden"
						value='${uname}' class="form-control" name="memberid" title="Must contain IT number" required>
					...
					<input type="text"
						...
						<table>
			<tr>
			<td><a href="borrowList.jsp"><button type="submit" class="btn btn-success">BORROW</button></a></td>
			<td></td>
